...
<%			} else{ %>
			...
			for(int idx = 0; idx < count; idx ++) {
				...
				String ACL_TYPE_C 			=	wnsearch.getField(thisCollection,"ACL_TYPE_C",				idx,false); 			
				String AUTHORITY_C 			=	wnsearch.getField(thisCollection,"AUTHORITY_C",				idx,false); 			
				String ACL_TYPE_W 			=	wnsearch.getField(thisCollection,"ACL_TYPE_W",				idx,false); 			
				String AUTHORITY_W 			=	wnsearch.getField(thisCollection,"AUTHORITY_W",				idx,false); 			
